...
const SUBSCRIBE_FORM_NAME = 'newsletter'  // your signup form's name
  ...
  try {
    ...
    if (formName === UNSUBSCRIBE_FORM_NAME) {
      ...
      const response = await fetch(url, {
        ...
        body: JSON.stringify({
          // Do not send email_address here
          type: 'unsubscribed',
        }),
      })
      ...
      // 200 updated; 404 means “email not found / already removed”; both count as success
